...
class Scheduler(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    author_id = db.Column(db.Integer)
    author_email = db.Column(db.String(250))
    six = db.Column(db.String(250), nullable=True)
    seven = db.Column(db.String(250), nullable=True)
    eight = db.Column(db.String(250), nullable=True)
    nine = db.Column(db.String(250), nullable=True)
    ten = db.Column(db.String(250), nullable=True)
    eleven = db.Column(db.String(250), nullable=True)
    twelve = db.Column(db.String(250), nullable=True)
    thirteen = db.Column(db.String(250), nullable=True)
    fourteen = db.Column(db.String(250), nullable=True)
    fifteen = db.Column(db.String(250), nullable=True)
    sixteen = db.Column(db.String(250), nullable=True)
    seventeen = db.Column(db.String(250), nullable=True)
    eighteen = db.Column(db.String(250), nullable=True)
